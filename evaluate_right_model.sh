...
# Right Side Model Evaluation Script
# Evaluates only the right side (47-48-PELLGREGORY) model
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "Options:"
            echo "  --model-path PATH    Path to trained right model (default: $MODEL_PATH)"
...
echo "Step 1: Generating predictions for right model..."
echo "----------------------------------------"
...
echo "Step 2: Evaluating right model performance..."
echo "----------------------------------------"
...
echo ""
echo "✅ Right model evaluation completed successfully!"
echo ""
echo "Results Summary:"
echo "  - Predictions saved in: $LOG_PATH/"
echo "  - Evaluated right side: 5 landmarks (47-48-PELLGREGORY)"
